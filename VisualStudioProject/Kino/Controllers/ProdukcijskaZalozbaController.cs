...
namespace Kino.Controllers {
    ...
    public class ProdukcijskaZalozbaController : Controller {
        ...
        public async Task<IActionResult> Create([Bind("Ime")] ProdukcijskaZalozba produkcijskaZalozba) {
            if (ModelState.IsValid) {
                ProdukcijskaZalozba p = new ProdukcijskaZalozba();
                p.Ime = produkcijskaZalozba.Ime;
                _context.Add(p);
